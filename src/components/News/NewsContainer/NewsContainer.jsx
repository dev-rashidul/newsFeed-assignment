...
import useData from "../../../Hooks/NewsHooks/useNewsQuery";
import thumb from "../../../assets/thumb.png";
import thumb_lg from "../../../assets/thumb_lg.png";

export default function NewsContainer() {

  const data = useData(`http://localhost:8000/v2/top-headlines`)
          ...
          <div className="col-span-12 grid grid-cols-12 gap-4">
            <div className="col-span-12 lg:col-span-4">
              ...
              <p className="text-base text-[#5C5955]">
                ...
                don’t—they’re the places that have historically supplied the
                keys for unlocking human potential. Though beset by racism and
                other injustices, cities not only provided shared, robust public
